  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod, XF86AudioMute, exec, wpctl set-mute @DEFAULT_SOURCE@ toggle && notify-send -h string:x-canonical-private-synchronous:mic \"\" \"\$(wpctl get-volume @DEFAULT_SOURCE@ | awk '{print (\$3 == \"[MUTED]\") ? \"MUTED\" : \"UNMUTED\"}')\""
      ];
      bindi = [
